      ...
      <div className="flex flex-col space-y-10 ">
        ...
        <div className="space-y-5 ">
          ...
          <div className="flex items-center justify-center space-x-5">
            ...
            <p className="text-2xl"> Kharar,Punjab,India </p>
          </div>
        </div>
        <form
        ...
        >
          ...
          <button
            type="submit"
            className="bg-[#0DB760] focus:bg-[#3c9c6a] text-white py-5 px-10 rounded-sm hover:opacity-70 tracking-widest font-bold text-lg"
          >
            SUBMIT
          </button>
        </form>

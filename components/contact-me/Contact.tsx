...
export default function Contact({}: Props) {
  ...
  return (
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-4xl px-10 justify-evenly mx-auto items-center">
      <h3 className="absolute top-24 uppercase tracking-[20px] text-[#0DB760] font-semibold text-xl md:text-2xl text-center w-full">
        Contact
      </h3>
      <div className="flex flex-col space-y-10">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col space-y-2 w-fit lg:mx-auto">
            <div className="flex space-x-2">
                <input {...register('name')} placeholder="Name" className="contactInput" type="text" id="" /> <input {...register('email')} placeholder="Email" className="contactInput" type="email" id="" />
            </div>
            <input {...register('subject')} placeholder="Subject" className="contactInput" type="text" id="" />
